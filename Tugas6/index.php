...
<body>
  <main class="grid place-items-center h-screen w-screen container mx-auto  ">
    <section class="flex space-x-6 py-6">
      <form class="bg-sky-100 p-6 pb-8 shadow hover:shadow-lg transition duration-300 flex flex-col space-y-4 rounded-lg" action="" method="POST">
        ...
        <button class="bg-green-400 text-white font-bold py-2 rounded outline-2 outline-green-500 hover:bg-green-500 active:bg-green-600 transition duration-300" type="submit">Hitung</button>
      </form>
      <?php if (isset($_POST["bilangan1"]) && isset($_POST["bilangan2"])) :
        $bilangan1 = $_POST["bilangan1"];
        $bilangan2 = $_POST["bilangan2"];
      ?>
        <section class="bg-sky-100 p-6 pb-8 shadow hover:shadow-lg transition duration-300 flex flex-col space-y-4 rounded-lg w-72 text-slate-700 font-medium">
